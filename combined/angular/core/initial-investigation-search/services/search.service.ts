...
import { MarkAsIncorrectMutation } from '../mutations/mark-as-incorrect.mutation';
import { RequestNewReportMutation } from '../mutations/request-new-report.mutation';
...
export class SearchService {
  ...
  requestNewReport(EnrollSubjectInput: object): Observable<any> {
    return this.apollo.mutate({
      mutation: RequestNewReportMutation,
  ...
  triggerReport(SubjectInfoInput: object, type: ReportType): Observable<any> {
    return this.apollo.mutate({
      mutation: RunReportMutation,
      variables: {subject: SubjectInfoInput, type: type.toUpperCase()}
    });
  ...
  markAsIncorrect(record: object): Observable<any> {
    return this.apollo.mutate({
      mutation: MarkAsIncorrectMutation,
      variables: {subject: record},
      refetchQueries: [
        {
          query: SearchReportsQuery,
          variables: { filters: this.last() },
