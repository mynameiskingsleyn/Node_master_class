...
@NgModule({
    declarations: [
        CreditReportContinuousMonitoringLayoutComponent,
        EchoHeaderComponent,
    ...
    exports: [CreditReportContinuousMonitoringLayoutComponent],
    providers: [
        { provide: DATE_FORMATS_CONFIG, useValue: APP_DATE_FORMATS },
    ]
})
export class CreditReportContinuousMonitoringLayoutModule { }
